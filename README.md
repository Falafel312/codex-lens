...
- The QR or pair code creates an AES-256-GCM encrypted channel between the Even app and the desktop companion.
- The hosted relay routes encrypted envelopes and cannot decrypt prompts or responses.
- Pairing QR codes and manual pair codes are one-time use, and relay sessions expire.
